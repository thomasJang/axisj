...
```js
	...
	$("#AXInputNumber").bindNumber(config);
```
**/
...
```js
	...
	$("#AXInputSelector").bindSelector(config);
```
**/
 ...
 * @example
```js
	$("#AXInputSelector").bindSelectorBlur();
```
**/
...
```js
	...
	$("#AXInputSlider").bindSlider(config);
```
**/
...
```js
	...
	$("#AXInputTwinSlider").bindTwinSlider(config);
```
**/
