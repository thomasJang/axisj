	    ...
	    if(this.target.get(0).tagName.lcase() == "form")
	    {
		    ...
		    if(cfg.onkeydown) {
			    if(cfg.keydown_check_classname){
				    this.target.find("."+cfg.keydown_check_classname).bind("keydown", function (event) {
					    cfg.onkeydown(event);
				    });
			    }
			    else
		    ...
		    if(cfg.onkeyup) {
			    if(cfg.keyup_check_classname){
				    this.target.find("."+cfg.keyup_check_classname).bind("keyup", function (event) {
					    cfg.onkeyup(event);
				    });
			    }
			    else
		    ...
		    if(cfg.onreturn) {
			    if(cfg.return_check_classname){
				    this.target.find("."+cfg.return_check_classname).bind("keydown", function (event) {
		    ...
		    if(cfg.onchange){
			    if(cfg.change_check_classname){
				    this.target.find("."+cfg.change_check_classname).bind("change", function (event) {
					    cfg.onchange(event);
				    });
			    }
			    else
			    {
				    this.target.find("input, select, textarea").bind("change", function(event){
					    cfg.onchange(event);
				    });
			    }
		    }
