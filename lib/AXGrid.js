 ...
 * @logs
 ...
 "2016-01-07 tom : config.hiddenBorder_tdLastChild 속성 추가 - head와 body의 각줄의 마지막 td의 border를 제거 하는 옵션
 * @example
 *```
 ...
 * }
    ...
    setColHead: function () {
        ...
        if (cfg.viewMode == "grid")
        {
            ...
            //AXGridTarget_AX_colHead_AX_0_AX_2config.hiddenBorder_tdLastChild 속성 추가 - head와 body의 각줄의 마지막 td의 border를 제거 하는 옵션
