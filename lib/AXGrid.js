        ...
        var getValueForSort = function (item, itemIndex) {
            if (myColHead.formatter) {
                ...
                if (myColHead.formatter == "money") {
                    ...
                    var moneyCheck = (Object.isString(result)) ? result.replace(/,/g, "").delHtml().trim() : result;
                    if (axdom.isNumeric(moneyCheck)) result = moneyCheck.number();
