 ...
 * @param {Function} onchange on change pageNo event
 *
 * @description
 '''js
 var gridData = {
 ...
 */
    setData: function (res) {
        ...
        //이벤트 네이밍 호환처리
        if(!res.onchange) res.onchange = res.onChange;
    ...
    openMobileConfig: function (event) {
        ...
        try{
            AXContextMenu.setConfig({responsiveMobile: cfg.autoChangeGridView.mobile[1]});
        }catch(e){
