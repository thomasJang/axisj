 ...
 * @example
 ...
 "2014-11-06 tom : checkedColSeq 메소드에서 oncheck 이벤트 지연호출 처리 취소 및 dayaSync 메소드 신설"
 "2014-11-08 tom : AXConfig.AXGrid.colHeadAlign > colHeadAlign에 연결되도록 구문 추가, appendList 위치 버그 픽스"
 "2014-11-14 root : [add] colGroup item 에 addClass 속성 추가"
 "2014-11-18 tom : fixedColSeq 표현 버그 픽스"
 "2014-11-23 tom : pushList 메소드 insertIndex 가 없으면 focus 실행 안함."
 "2014-11-24 tom : window resize 이벤트 시 스크롤 초기화 문제 해결 & axdom(document.body).addClass("AXUserSelectNone") 제거 button text 스타일 깨짐 문제 발생"
 "2014-11-16 tom : grid getCheckedList radio 타입 에러 해결"
 "2014-12-03 tom : colGroupListClick 버그 픽스 - 컬럼 보이기 감추기 기능"
 "2014-12-12 tom : checkbox click 지연 이슈 해결"
 "2014-12-15 tom : 스크롤바 X 이동시 실시간 처리로 방식 변경"
 "2014-12-23 tom : keydown이벤트로 포커스 이동 처리"
 "2014-12-23 tom : redrawGrid 버그 픽스"
