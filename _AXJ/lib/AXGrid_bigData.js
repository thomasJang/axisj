...
var AXGrid = Class.create(AXJ, {
	...
	setBody: function (list, rewrite) {
		...
		var po = [];
		/* body 0 --- s */
		po.push("<div id=\"" + cfg.targetID + "_AX_scrollContent_0\" class=\"gridScrollContent\">");
			po.push("<table cellpadding=\"0\" cellspacing=\"0\" class=\"gridBodyTable\"  id=\"" + cfg.targetID + "_AX_gridBodyTable_0\">");
			po.push(this.getColGroup("CB")); /*colGroup 삽입 */
			po.push("<thead id=\"" + cfg.targetID + "_AX_thead_0\"></thead>");
			po.push("<tbody id=\"" + cfg.targetID + "_AX_tbody_0\">");
			po.push("<tr class=\"noListTr\">");
				po.push("<td colspan=\"" + (this.showColLen) + "\">");
					po.push("<div class=\"tdRelBlock\"><div class=\"bodyNode bodyTdText\" align=\"center\">");
			...
			po.push("</tr>");
			po.push("</tbody>");
			po.push("<tfoot id=\"" + cfg.targetID + "_AX_tfoot_0\"></tfoot>");
			po.push("</table>");
			po.push("<div class=\"gridBodyDiv\" id=\"" + cfg.targetID + "_AX_gridBodyDiv_0\"></div>");
		po.push("</div>");
		/* body 0 --- e */
		/* body 1 --- s */
		po.push("<div id=\"" + cfg.targetID + "_AX_scrollContent_1\" class=\"gridScrollContent\" style=\"display:none;\">");
			po.push("<table cellpadding=\"0\" cellspacing=\"0\" class=\"gridBodyTable\"  id=\"" + cfg.targetID + "_AX_gridBodyTable_1\">");
			po.push(this.getColGroup("CB")); /*colGroup 삽입 */
			po.push("<thead id=\"" + cfg.targetID + "_AX_thead_1\"></thead>");
			po.push("<tbody id=\"" + cfg.targetID + "_AX_tbody_1\">");
			po.push("<tr class=\"noListTr\">");
				po.push("<td colspan=\"" + (this.showColLen) + "\">");
					po.push("<div class=\"tdRelBlock\"><div class=\"bodyNode bodyTdText\" align=\"center\">");
						po.push(AXConfig.AXGrid.emptyListMSG);
			...
			po.push("</tr>");
			po.push("</tbody>");
			po.push("<tfoot id=\"" + cfg.targetID + "_AX_tfoot_1\"></tfoot>");
			po.push("</table>");
			po.push("<div class=\"gridBodyDiv\" id=\"" + cfg.targetID + "_AX_gridBodyDiv_1\"></div>");
		po.push("</div>");
		/* body 1 --- e */
		...
		this.scrollContent_0 = jQuery(cfg.targetID + "_AX_scrollContent_0");
			this.scrollContent_0_thead = jQuery(cfg.targetID + "_AX_thead_0");
			this.scrollContent_0_tbody = jQuery(cfg.targetID + "_AX_tbody_0");
			this.scrollContent_0_tfoot = jQuery(cfg.targetID + "_AX_tfoot_0");

		this.scrollContent_1 = jQuery(cfg.targetID + "_AX_scrollContent_1");
			this.scrollContent_1_thead = jQuery(cfg.targetID + "_AX_thead_1");
			this.scrollContent_1_tbody = jQuery(cfg.targetID + "_AX_tbody_1");
			this.scrollContent_1_tfoot = jQuery(cfg.targetID + "_AX_tfoot_1");
