...
var api_list = [
	{uri:"api/core/AXConfig.html", title:"AXConfig", desc:"axisj config"},
	{uri:"api/core/AXUtil.html", title:"AXUtil", desc:"axisj util functions"}
];


var sampleTree = [
    {menuID:"1", label:"Core", url:"javascript:pageObj.goLink('api/core/AXConfig.html');", cn:[
        {menuID:"101", label:"AXConfig", url:"javascript:pageObj.goLink('api/core/AXConfig.html');"},
        {menuID:"102", label:"AXUtil", url:"javascript:pageObj.goLink('api/core/AXUtil.html');"},
        {menuID:"103", label:"AXCore", url:"javascript:pageObj.goLink('api/core/AXCore.html');"}
    ]},
...
(function(){
    pageObj = {
        ...
        incHeader:function(){
                        ...
                        ho.push('<div class="ax-col-12">');
                            ho.push('<div class="ax-unit">');
                                ho.push('<nav class="navMenu ">');
                                    ho.push('<h3><a href="'+pageObj.host+'index.html"><img src="'+pageObj.host+'/AXJ-logo.png" style="width:110px; height:40px;" /></a></h3>');
            ...
            to.push("<div class='logo'><img src='"+pageObj.host+pageObj.theme+"/dx-theme-logo.png' /></div>");
            to.push("<h1>");
